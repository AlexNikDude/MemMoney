-- Drop the existing table and recreate with better precision
...
COMMENT ON COLUMN conversion_rates.rate IS 'Conversion rate from from_currency to to_currency (supports very small and very large rates)';
